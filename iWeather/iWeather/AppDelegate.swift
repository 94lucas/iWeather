...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    @objc func dismissLaunchScreen() {
            ...
            let mainViewController = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "ViewController")
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "iWeather")
